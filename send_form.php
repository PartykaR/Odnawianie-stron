...
if($name && $email && $phone && $message){
 ...
 $message_body="Formularz kontaktowy wysłany ze strony http://odnawianie-stron-www.pl\n";
 $message_body.="Imię i nazwisko: $name\n";
 $message_body.="Adres email: $email\n";
 $message_body.="Numer telefonu: $phone\n\n";
 $message_body.=$message;
 if(mail("info@odnawianie-stron-www.pl","Formularz kontaktowy",$message_body,$headers)){
